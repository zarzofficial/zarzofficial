...
const rawProducts: Product[] = [
  {
    ...
    details: {
      ...
      duration: "شهر واحد",
      delivery: "واتساب",
      options: [{ label: "اشتراك شهر واحد", price: 34999 }],
    },
    reviewCount: 222,
    stock: 14,
    variationGroups: [
  ...
  },
  {
    ...
    details: {
      ...
      delivery: "واتساب",
      options: [
        { label: "اشتراك شهر واحد", price: 15500 },
  ...
  },
  {
    ...
    rating: "5.0",
    outOfStock: false,
    features: ["حسابات نشطة بمظهر طبيعي", "جودة حقيقية ثابتة", "متابعة تنفيذ واضحة", "خدمة مضمونة"],
    details: { type: "متابعون حقيقيون بجودة ثابتة", delivery: "1-2 ساعة", batch: 1 },
    reviewCount: 286,
    stock: 84,
    featured: true,
    variationGroups: [
      {
        ...
        label: "الجودة",
        options: [
          { id: "real-fixed", label: "جودة حقيقية ثابتة" },
        ],
      },
    ],
  },
  {
    ...
    outOfStock: false,
    features: ["حسابات نشطة بمظهر طبيعي", "جودة حقيقية ثابتة", "متابعة تنفيذ واضحة", "خدمة مضمونة"],
    details: { type: "متابعون حقيقيون بجودة ثابتة", delivery: "5-30 دقيقة", batch: 1 },
    reviewCount: 342,
    stock: 91,
    featured: true,
    variationGroups: [
  ...
  },
  {
    ...
    outOfStock: false,
    features: ["حسابات نشطة بمظهر طبيعي", "جودة حقيقية ثابتة", "متابعة تنفيذ واضحة", "خدمة مضمونة"],
    details: { type: "متابعون حقيقيون بجودة ثابتة", delivery: "1-3 ساعات", batch: 1 },
    reviewCount: 168,
    stock: 47,
    variationGroups: [
      {
