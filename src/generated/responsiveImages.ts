export const responsiveImageWidths: Record<string, readonly number[]> = {
  "/assets/chatgpt-plus-v4.avif": [160, 320, 480, 560, 640, 960, 1280, 1600],
  "/assets/ecommerce-store-v4.avif": [160, 320, 480, 560, 640, 960, 1024],
  ...
  "/assets/web-modification-v4.avif": [160, 320, 480, 560, 640, 960, 1280, 1600],
  "/assets/webstore-rental-v1.avif": [160, 320, 480, 560, 640, 960, 1024],
};
