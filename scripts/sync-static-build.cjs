...
const defaultDescription =
  "زارز متجر رقمي للخدمات والمنتجات الرقمية يشمل اشتراكات الذكاء الاصطناعي، شحن الألعاب، وخدمات السوشيال ميديا بسرعة ودعم مباشر.";
...
const routeDescriptions = new Map([
  ...
  [
    "products",
    "تصفح منتجات زارز الرقمية من اشتراكات الذكاء الاصطناعي، شحن الألعاب، وحلول السوشيال ميديا.",
  ],
  [
    "products/catalog",
    "تصفح أقسام منتجات زارز الرقمية حسب الفئة للوصول السريع إلى خدمات الذكاء الاصطناعي والألعاب والسوشيال ميديا.",
  ],
  [
    "products/catalog/social",
